...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md border-border/60 bg-card/90 backdrop-blur-sm shadow-xl">
        <CardHeader className="text-center pb-2 pt-8">
          <CardTitle className="text-2xl bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Astute CMS</CardTitle>
