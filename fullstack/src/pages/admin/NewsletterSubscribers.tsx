  ...
  return (
    <AdminLayout>
      ...
      <div className="grid grid-cols-2 gap-5 mb-8">
        <div className="p-5 border border-border/60 rounded-2xl bg-card/80">
          ...
          <div className="text-3xl font-bold tracking-tight mt-3">{totalCount}</div>
        </div>
        <div className="p-5 border border-border/60 rounded-2xl bg-card/80">
          <div className="flex items-center gap-2 text-muted-foreground text-sm">
          ...
          <div className="text-3xl font-bold tracking-tight mt-3 text-green-500">{activeCount}</div>
        </div>
      </div>
