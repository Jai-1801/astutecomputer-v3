      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" className="rounded-xl" onClick={() => navigate('/admin/case-studies')}>
          ...
          <div className="flex items-center gap-2 ml-auto sm:ml-0">
            ...
            <Button className="rounded-xl" onClick={() => handleSave(false)} disabled={isSaving}>
              {isSaving ? (
            ...
            {!isPublished && (
              <Button variant="default" className="rounded-xl" onClick={() => handleSave(true)} disabled={isSaving}>
                Publish
              </Button>
            )}
          </div>
        ...
        <div className="space-y-8">
          {/* Thumbnail Section */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
          ...
          {/* Metadata Section */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">Metadata</h2>
            <div className="grid gap-4">
              <div className="grid sm:grid-cols-2 gap-4">
                <div>
          ...
          {/* Results Section */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">Results / Key Metrics</h2>
            <ResultsBuilder value={results} onChange={setResults} />
          </section>

          {/* Section Content */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">Section Content</h2>
            <SectionContentEditor value={sectionContent} onChange={setSectionContent} />
          </section>

          {/* Legacy Content Editor */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-2">Additional Content (Legacy)</h2>
          ...
          {/* FAQs */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">FAQs</h2>
            <FAQBuilder value={faqs} onChange={setFaqs} />
          </section>

          {/* Related Content */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">Related Content</h2>
          ...
          {/* Gallery */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">Gallery</h2>
            <GalleryManager caseStudyId={isNew ? undefined : id} />
          </section>

          {/* SEO */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">SEO</h2>
            <div className="grid gap-4">
              <div>
          ...
          {/* Publishing */}
          <section className="bg-card/80 border border-border/60 rounded-2xl p-6 sm:p-8">
            <h2 className="text-lg font-semibold mb-5">Publishing</h2>
